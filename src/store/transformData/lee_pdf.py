...
prov = ['Arg', 'Buenos Aires', 'Ciudad de Buenos Aires', 'Catamarca', 'Chaco', 'Chubut', 'rdoba', 'Corrientes',
        'Entre R', 'Formosa', 'Jujuy', 'La Pampa', 'La Rioja', 'Mendoza', 'Misiones ', 'Neuqu', 'o Negro', 'Salta',
        'San Juan', 'San Luis', 'Santa Cruz', 'Santa Fe', 'Santiago del Estero', 'Tierra del Fuego', 'Tucum']

directorio = ['arg', 'buenosaires', 'caba', 'catamarca', 'chaco', 'chubut', 'cordoba', 'corrientes', 'entrerios',
              'formosa', 'jujuy', 'lapampa', 'larioja', 'mendoza', 'misiones', 'neuquen', 'rionegro', 'salta',
              'sanjuan', 'sanluis', 'santafe', 'santiago', 'santacruz', 'tfuego', 'tucuman']
                    ...
                    if prov[j] in line:
                        ...
                        if not (prov[j] == 'Buenos Aires' and words[1] == 'Ciudad'):
                            ...
                            if len(words) == 3:
                                jn = -2
                            if len(words) == 1:
                                words = ['0', '0', '0']  # problems with negative values?
                            if len(words) == 2:
                                jn = -1
                            if words[-2] != '|':
